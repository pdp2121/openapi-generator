...
------------ | ------------- | ------------- | -------------
**deliver_max** | [**CurrencyAmount**](CurrencyAmount.md) | Only available in API v2. The maximum amount of currency to deliver. For non-XRP amounts, the nested field names MUST be lower-case. If the tfPartialPayment flag is set, deliver up to this amount instead. New in: rippled 2.0.0 | 
