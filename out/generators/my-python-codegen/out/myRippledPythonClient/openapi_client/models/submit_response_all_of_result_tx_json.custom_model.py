...
class SubmitResponseAllOfResultTxJson(BaseModel):
    """
    SubmitResponseAllOfResultTxJson
    """ # noqa: E501
    hash: Optional[StrictStr] = None
    ledger_index: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["hash", "ledger_index"]
