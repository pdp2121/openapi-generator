...
class SignAndSubmitModeV1(BaseModel):
    """
    SignAndSubmitModeV1
    """ # noqa: E501
    tx_json: Dict[str, Any] = Field(description="Transaction definition in JSON format, optionally omitting any auto-fillable fields.")
