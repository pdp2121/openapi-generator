...
class SchemasAccountChannelsRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    method: str = "schemas_account_channels"
    method: StrictStr
    params: Optional[List[AccountChannelsRequest]] = None
    __properties: ClassVar[List[str]] = ["method", "params"]

    @field_validator('method')
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['account_channels']):
            raise ValueError("must be one of enum values ('account_channels')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.params:
            ...
            _dict_snake_case['params'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": [AccountChannelsRequest.from_dict(_item) for _item in obj["params"]] if obj.get("params") is not None else None
        })
        return _obj
