...
class SubmitResponseV1(BaseModel):
    """
    SubmitResponseV1
    """ # noqa: E501
    result: SubmitResponseV1Result
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": SubmitResponseV1Result.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
