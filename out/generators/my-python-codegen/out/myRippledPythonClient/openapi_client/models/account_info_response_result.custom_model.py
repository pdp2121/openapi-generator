...
class AccountInfoResponseResult(BaseModel):
    """
    AccountInfoResponseResult
    """ # noqa: E501
    account_data: Optional[AccountInfoResponseResultAccountData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account_data": AccountInfoResponseResultAccountData.from_dict(obj["account_data"]) if obj.get("account_data") is not None else None
        })
        return _obj
