...
class SchemasAccountInfoRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    method: str = "schemas_account_info"
    method: StrictStr
    params: Optional[List[AccountInfoRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": [AccountInfoRequest.from_dict(_item) for _item in obj["params"]] if obj.get("params") is not None else None
        })
        return _obj
