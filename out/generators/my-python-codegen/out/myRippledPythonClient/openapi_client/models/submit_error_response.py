...
class SubmitErrorResponse(BaseModel):
    ...
    SubmitErrorResponse
    """ # noqa: E501
    error: SubmitErrorResponseError
    status: StrictStr
    request: SubmitErrorResponseRequest
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": SubmitErrorResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "status": obj.get("status"),
            "request": SubmitErrorResponseRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
