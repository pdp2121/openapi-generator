...
class AccountChannelsResponseAllOfResult(BaseModel):
    """
    AccountChannelsResponseAllOfResult
    """ # noqa: E501
    account: Optional[StrictStr] = None
    channels: Optional[List[AccountChannelsResponseAllOfResultChannels]] = None
    __properties: ClassVar[List[str]] = ["account", "channels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "channels": [AccountChannelsResponseAllOfResultChannels.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None
        })
        return _obj
