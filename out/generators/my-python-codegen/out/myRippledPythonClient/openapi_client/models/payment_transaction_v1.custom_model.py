...
class PaymentTransactionV1(BaseModel):
    """
    PaymentTransactionV1
    """ # noqa: E501
    amount: CurrencyAmount = Field(description="Only available in API v1. The maximum amount of currency to deliver. For non-XRP amounts, the nested field names MUST be lower-case. If the tfPartialPayment flag is set, deliver up to this amount instead.", alias="Amount")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.deliver_min:
            _dict['DeliverMin'] = self.deliver_min.to_dict()
        ...
        if self.send_max:
            _dict['SendMax'] = self.send_max.to_dict()
        return _dict
