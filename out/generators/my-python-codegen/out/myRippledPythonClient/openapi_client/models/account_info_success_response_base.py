...
class AccountInfoSuccessResponseBase(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["forwarded", "status", "warning", "warnings", "account_flags", "ledger_current_index", "ledger_index", "queue_data", "validated"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.account_flags:
            _dict_snake_case['account_flags'] = self.account_flags.to_dict()
        # override the default output from pydantic by calling `to_dict()` of queue_data
        if self.queue_data:
            _dict_snake_case['queue_data'] = self.queue_data.to_dict()
