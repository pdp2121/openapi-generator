...
class TestSignerEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SignerEntry:
        """Test SignerEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignerEntry`
        """
        model = SignerEntry()
        if include_optional:
            return SignerEntry(
