 ...
 * 1) Set a break point in MyPythonCodegenGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class MyPythonCodegenGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("my-python-codegen") // use this codegen library
              ...
              .setOutputDir("out/my-python-codegen"); // output directory
